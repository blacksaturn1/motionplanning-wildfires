...
from valet.node import Node, NodeEdge

# from: https://github.com/abdurj/Local-Planner-Visualization-Project/tree/master/search
...
class AStar(InformedSearch):
    ...
    def heuristic(self, curr_node, neighbour_node):
        return helper.dist_to_node(neighbour_node, self.gn)
